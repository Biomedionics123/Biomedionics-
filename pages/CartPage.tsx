                     ...
                     <div>
                      ...
                      <div>
                       ...
                       <div>
                        ...
                        <textarea name="address" id="address" rows={3} required value={customerDetails.address} onChange={handleChange} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"></textarea>
                      </div>
